...
class UsuarioCliente extends ModeloBaseDeDatos{
    ...
    function crear_registro(){
        ...
        $this->sentencia_sql="SELECT fun_registrar_usuario_".$this->TABLA."('$this->valor_nombre','$this->valor_apellido','$this->valor_documento','$this->valor_telefono','$this->valor_celular','$this->valor_correo','$this->valor_tarjeta') as respuesta";
