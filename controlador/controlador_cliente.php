...
if(isset($_POST['datos'])){
    ...
    $objeto= new UsuarioCliente();//Mi clase  modelo 
    ...
    switch($operacion){
        case "crear":
             ...
             */
            $objeto->valor_nombre=trim($post->datos->nombre_cliente);
            $objeto->valor_apellido=trim("n/a");
            $objeto->valor_telefono=trim("n/a");
            $objeto->valor_documento=trim($post->datos->cedula_cliente);
            $objeto->valor_correo=trim("n/a");  
            $objeto->valor_celular=trim("n/a");
        ...
        case "consultarTodos":
            ...
            break;
        case "consultar":
            $objeto->valor_documento=  trim($post->datos->documento_cliente);
            echo json_encode($objeto->obtener_registros_por_cedula());            
            break;
        default :
